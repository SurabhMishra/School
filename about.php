...
<div class="jumbotron">
  <h1>Banglore univercity</h1>
  <p>Populuar School in Banglore.</p>
</div>
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-12">
        <img src="I/k.jpg" class="img-fluid aboutimg">
    </div>
    <div class="col-lg-6 col-md-6 col-12">
        <h2 class = "display-4">Banglore Univercity</h2>
...
<!-- <footer>
    <p class="p-3 bg-dark text-white text-center">@Banglore Univercity</p>
</footer> -->
